        ...
        >
          {items.map(({ key, label, icon, active, onClick }) => (
            <button
              ...
              className={`flex w-full items-center gap-2.5 px-3 py-2 text-xs transition-colors hover:bg-white/5 cursor-pointer ${active ? 'text-white/70' : 'text-white/40 hover:text-white/70'
                }`}
            >
              {icon}
              {label}
