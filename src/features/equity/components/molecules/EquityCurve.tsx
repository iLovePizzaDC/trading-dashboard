      ...
      <div className='mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between'>
        ...
        <div className='flex items-center justify-between gap-4 text-xs sm:justify-end'>
          ...
          <button
            ...
            className={`flex items-center gap-1 transition cursor-pointer ${showSpy ? 'text-white/60' : 'text-white/25'
              }`}
          >
            <span
              className={`h-2 w-2 rounded-full border ${showSpy ? 'border-white/50 bg-transparent' : 'border-white/20 bg-transparent'
                }`}
              style={
                showSpy
                  ? {
