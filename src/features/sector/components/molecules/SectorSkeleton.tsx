function SkeletonBox({ className }: { className?: string }) {
  return (
    <div
      ...
      data-testid='sector-skeleton-box'
    >
...
function SectorSkeleton() {
  return (
    <div className='rounded-xl border border-white/10 bg-linear-to-br from-white/5 to-white/0 p-4'>
      <div className='mb-3 flex items-center justify-between' data-testid='sector-header'>
      ...
      <div className='space-y-1.5'>
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className='flex items-center gap-3' data-testid='sector-row-placeholder'>
